@props(['color' => 'primary', 'size' => null, 'loading' => false])

@php
    $colorStyle = match($color) {
        'primary', 'red'                 => 'bg-red-200    text-red-900    dark:bg-red-800    dark:text-red-100',
        'secondary', 'tertiary', 'gray'  => 'bg-gray-200   text-gray-700   dark:gray-900      dark:text-gray-800',
