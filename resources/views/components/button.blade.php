...
@php
    $baseStyle = 'group whitespace-nowrap transition duration-150 inline-flex items-center justify-center border font-bold rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-800';

    $colorStyle = match($color) {
        'primary' =>   'bg-primary-100  border-primary-100  hover:bg-primary-200  text-primary-700  focus:ring-primary-300  dark:bg-primary-800  dark:border-primary-800  dark:hover:bg-primary-700  dark:text-gray-100 dark:focus:ring-primary-700',
        ...
        'tertiary' =>  'bg-none         border-none         hover:bg-gray-200     text-gray-500     focus:ring-gray-300     dark:none            dark:border-none         dark:hover:bg-gray-900     dark:text-gray-100 dark:focus:ring-gray-600',
