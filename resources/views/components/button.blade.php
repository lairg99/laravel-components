...
@php
    ...
    $colorStyle = match($color) {
        ...
        'tertiary' =>  'bg-none         border-gray-200     hover:bg-gray-200     text-gray-500     focus:ring-gray-300    active:ring-gray-300     dark:none            dark:border-gray-700     dark:hover:bg-gray-900     dark:text-gray-100 dark:focus:ring-gray-600    dark:active:ring-gray-600',
