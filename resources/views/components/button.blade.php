...
@php
    ...
    $colorStyle = match($color) {
        'primary' =>   'bg-primary-100  border-primary-100  hover:bg-primary-200  text-primary-800  focus:ring-primary-300  dark:bg-primary-800  dark:border-primary-800  dark:hover:bg-primary-700  dark:text-gray-100 dark:focus:ring-primary-700',
